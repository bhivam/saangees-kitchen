...
var _Surge_instances, _a, _Surge_encoder, _Surge_baseURLOverridden;
Object.defineProperty(exports, "__esModule", { value: true });
exports.Surge = void 0;
...
const blasts_1 = require("./resources/blasts.js");
const campaigns_1 = require("./resources/campaigns.js");
...
const verifications_1 = require("./resources/verifications.js");
...
class Surge {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('SURGE_BASE_URL'), apiKey = (0, env_1.readEnv)('SURGE_API_KEY'), webhookSigningSecret = (0, env_1.readEnv)('SURGE_WEBHOOK_SIGNING_SECRET') ?? null, ...opts } = {}) {
        _Surge_instances.add(this);
        _Surge_encoder.set(this, void 0);
        this.accounts = new API.Accounts(this);
        this.blasts = new API.Blasts(this);
        ...
        if (apiKey === undefined) {
            throw new Errors.SurgeError("The SURGE_API_KEY environment variable is missing or empty; either provide it, or instantiate the Surge client with an apiKey option, like new Surge({ apiKey: 'My API Key' }).");
        }
        const options = {
            apiKey,
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('SURGE_LOG'), "process.env['SURGE_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _Surge_encoder, Opts.FallbackEncoder, "f");
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _Surge_instances, "m", _Surge_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _Surge_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.Surge = Surge;
_a = Surge, _Surge_encoder = new WeakMap(), _Surge_instances = new WeakSet(), _Surge_baseURLOverridden = function _Surge_baseURLOverridden() {
    return this.baseURL !== 'https://api.surge.app';
};
Surge.Surge = _a;
Surge.DEFAULT_TIMEOUT = 60000; // 1 minute
Surge.SurgeError = Errors.SurgeError;
Surge.APIError = Errors.APIError;
Surge.APIConnectionError = Errors.APIConnectionError;
Surge.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
Surge.APIUserAbortError = Errors.APIUserAbortError;
Surge.NotFoundError = Errors.NotFoundError;
Surge.ConflictError = Errors.ConflictError;
Surge.RateLimitError = Errors.RateLimitError;
Surge.BadRequestError = Errors.BadRequestError;
Surge.AuthenticationError = Errors.AuthenticationError;
Surge.InternalServerError = Errors.InternalServerError;
Surge.PermissionDeniedError = Errors.PermissionDeniedError;
Surge.UnprocessableEntityError = Errors.UnprocessableEntityError;
Surge.toFile = Uploads.toFile;
Surge.Accounts = accounts_1.Accounts;
Surge.Blasts = blasts_1.Blasts;
Surge.Campaigns = campaigns_1.Campaigns;
Surge.Contacts = contacts_1.Contacts;
Surge.Messages = messages_1.Messages;
Surge.PhoneNumbers = phone_numbers_1.PhoneNumbers;
Surge.Users = users_1.Users;
Surge.Verifications = verifications_1.Verifications;
Surge.Webhooks = webhooks_1.Webhooks;
